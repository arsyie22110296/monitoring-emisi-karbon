...
with st.sidebar:
    ...
    # Tampilkan faktor emisi yang digunakan
    ...
    # Tampilkan faktor emisi yang relevan
    st.caption(f"""
...
if uploaded_file is not None:
    ...
    # Hitung emisi dengan jenis bahan bakar yang dipilih
    ...
    if st.session_state.get('clustering_done', False):
        ...
        # Rekomendasi berdasarkan cluster tertinggi
        ...
        # Rekomendasi berdasarkan sumber emisi terbesar
    ...
    # CSS sederhana untuk styling tombol download button Streamlit
    st.markdown("""
    <style>
    /* Style tombol download Streamlit */
